...
public class ListaObj <T> {
    ...
    public int buscar(T elementoBusca){
        int indice = 0;
    ...
    public void substitute(T elementoAntigo, T elementoNovo){
        int indice = buscar(elementoAntigo);
    ...
    public void trocarPosicao(T elemento1, T elemento2){
        int indice1 = buscar(elemento1);
        int indice2 = buscar(elemento2);

        if(indice1 != -1 || indice2 != -1){
            vetor[indice1] = elemento2;
            vetor[indice2] = elemento1;
        }
    }

    public T[] exibir(){
        T[] copia = (T[]) new Object[nroElem];

        System.arraycopy(vetor, 0, copia, 0, nroElem);
